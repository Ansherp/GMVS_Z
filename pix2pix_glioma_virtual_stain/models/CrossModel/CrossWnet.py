...
from models.CrossModel.Net_blocks import StackDecoder, StackEncoder, ConvBnRelu2d


class Cross_UNet(nn.Module):
    def __init__(self, in_channel, out_channel=3, is_bn=False):
        super(Cross_UNet, self).__init__()
        C = in_channel
       ...
       # self.v_down1_5 = ConvBnRelu2d(32 * 2, 32, kernel_size=1, padding=0, stride=1, is_bn=is_bn)
        ...
        self.final = nn.Conv2d(16, out_channel, kernel_size=3, padding=1, stride=1, bias=True)
