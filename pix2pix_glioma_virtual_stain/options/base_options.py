...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='global', help='selects model to use for netG [UNet][global][encoder][local][DinkNet34][HRnet][Cross]')
        ...
        self.parser.add_argument('--datatype_mat_n', type=int, default=-1) 
        self.parser.add_argument('--dataroot_custom', action='store_true') 
        self.parser.add_argument('--dataroot_A', type=str, default='') 
        self.parser.add_argument('--dataroot_B', type=str, default='') 
